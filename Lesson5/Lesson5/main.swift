...
print("\nProblem 1 ------------------------------\n");
//
// Earlier we used the method, removeAtIndex() to remove the first letter of a string. This method belongs to the String
// class. See if you can use this same method to return the last letter of a string.
...
print("\nProblem 2 ------------------------------\n");
//
// Write a function called combineLastCharacters. It should take in an array of strings, collect the last character of
// each string and combine those characters to make a new string to return. Use the strategy you discovered in Problem 1
// along with a for-in loop to write combineLastCharacters. Then try it on the nonsenseArray below.
var nonsenseArray = ["bungalow", "buffalo", "indigo", "although", "Ontario", "albino", "%$&#!"]
func combineLastCharacters()
